...
// the values for the psqts are from https://www.chessprogramming.org/PeSTO%27s_Evaluation_Function
...
pub const PSQTS_MG: [Psqt; NrOf::PIECE_TYPES] =
    [KING_MG, QUEEN_MG, ROOK_MG, BISHOP_MG, KNIGHT_MG, PAWN_MG];

pub const PSQTS_EG: [Psqt; NrOf::PIECE_TYPES] =
